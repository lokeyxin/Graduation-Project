...
INSERT INTO t_knowledge_item (document_id, question, answer, status)
VALUES (1, '如何查询订单状态？', '请在订单详情页查看物流与处理进度，或提供订单号给客服代查。', 1),
       (1, '订单可以退款吗？', '支持退款。若未发货可直接退款，已发货需先提交退货申请并经审核后退款。', 1),
       (1, '快递单号多久更新？', '一般发货后2到6小时会同步快递单号，节假日可能略有延迟。', 1),
       (2, '忘记密码怎么办？', '请在登录页点击“忘记密码”，通过手机号或邮箱验证后重置密码。', 1),
       (2, '如何联系客服？', '可在帮助中心提交工单，或在工作时间通过在线客服入口联系人工客服。', 1),
       (2, '发票如何开具？', '在订单完成后进入订单详情选择“申请发票”，按提示填写抬头和税号信息。', 1);
